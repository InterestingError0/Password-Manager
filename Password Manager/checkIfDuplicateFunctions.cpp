...
bool checkIfLoginIsDuplicate(const std::vector <std::vector <std::string>>& logins, const std::string_view webAddress, const std::string_view username) {
...
bool checkIfSecureNoteIsDuplicate(const std::vector <std::vector <std::string>>& secureNotes, const std::string_view title) {
